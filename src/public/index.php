...
$router->add('GET','filterByEmail',  'TasksController', 'renderAllTasksByEmail');
$router->add('GET','filterByName',  'TasksController', 'renderAllTasksByName');
$router->add('GET','filterByDone',  'TasksController', 'renderAllTasksByDone');
